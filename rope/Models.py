...
MODEL_INVENTORY = (
    ...
    ('inswapper_256_phase1.onnx', 'Inswapper 256 (phase 1, native)',    False),
...
MODEL_INVENTORY_DETAILS = {
    ...
    'inswapper_256_phase1.onnx': {'models_attr': 'swapper_256_model', 'trt_engine': 'inswapper_256_phase1.engine'},
