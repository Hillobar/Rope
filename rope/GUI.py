...
class GUI(tk.Tk):
    def __init__( self ):  
        ...
        # Left Canvas
        self.options_frame_canvas1 = tk.Canvas( self.options_frame, height = 105, width=625, bg='grey50' )
        ...
        self.label_frame3 = tk.LabelFrame( self.options_frame_canvas1, height = 100, width = 200, bg='grey50' )
        ...
        self.num_threads_id = tk.Label(self.label_frame3, width = 15, height=1, bg='grey75', text="Number of threads")
        self.num_threads_id.place(x=60, y=7)
        ...
        self.face_thresh_id = tk.Label(self.label_frame3, width = 15, height=1, bg='grey75', text="Face threshhold")
        self.face_thresh_id.place(x=60, y=32)
    ...
    def toggle_swapper(self):
        ...
        if self.swap == False:
            self.video_stop.config(relief=tk.RAISED)
        else:
            self.video_stop.config(relief=tk.SUNKEN) 
